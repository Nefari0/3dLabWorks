...
const Prototype = (props) => {
    ...
    return(
        ...
        <section className="login-title">
            ...
            {/* <svg className="close-button" style={{color:'#fff', height:'35px',width:'35px',opacity:'60%',marginTop:'2px',marginBottom:'2px'}} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 20 20" >
