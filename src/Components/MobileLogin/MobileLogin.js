...
const MobileLogin = (props) => {
    ...
    return(
        ...
        <ul className="buttons">
            ...
            {!saveSession ?
            <svg onClick={() => props.setSaveSession()} style={{marginLeft:'10px',marginRight:'20px', height:'20px',width:'20px',opacity:'60%',marginTop:'10px',marginBottom:'2px'}} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 20 20" fillRule="currentColor">
            ...
            :
            <svg onClick={() => props.setSaveSession()} style={{marginLeft:'10px',marginRight:'20px', height:'20px',width:'20px',opacity:'60%',marginTop:'10px',marginBottom:'2px'}} xmlns="http://www.w3.org/2000/svg" fillRule="none" viewBox="0 0 24 24" stroke="currentColor">
