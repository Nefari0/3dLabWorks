    ...
    render() {
        ...
        return(
            ...
            <div className={`messages-container`}>
                ...
                {contactAdmin === false ? <svg onClick={() => this.setContactAdmin()} xmlns="http://www.w3.org/2000/svg" className={`admin-message-icon`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
