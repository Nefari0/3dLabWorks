...
export const LoginIcon = () => {
    return ( 
        <svg xmlns="http://www.w3.org/2000/svg" className="header-menu-icon" style={{color:'#fff',marginLeft:'7px'}} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
