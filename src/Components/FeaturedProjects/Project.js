    ...
    return(
        <div className='project-container' onClick={gotClicked}>
            ...
            <div className="download-container">
                ...
                <a href={`${firebase_url}`} ><svg className="small-icon" style={{margin:'auto', height:'50px',width:'50px'}} xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
