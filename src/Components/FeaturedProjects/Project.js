    ...
    return(
        <div className='project-container' style={{overflow:'hidden'}}>
            ...
            <header style={{backgroundColor:''}}>
                ...
                <p className='dark-text' style={{backgroundColor:'',paddingBottom:'15px',paddingTop:'',fontSize:'16px'}}>{name}
            ...
            <section style={{backgroundColor:''}} >
                ...
                { isLoggedIn ? 
                <a style={{marginRight:'10px'}} href={`${firebase_url}`} target="_blank" rel="noopener noreferrer">download</a>
                    : 
                <a style={{marginRight:'10px',color:'blue'}} onClick={() => plsSignIn()}>download</a>}
