...
module.exports = {
    register: async (req,res) => {
        ...
        const photo_url = "https://firebasestorage.googleapis.com/v0/b/depot-7bb3e.appspot.com/o/Chris%20deMontigny%2Fphotos%2Fprofile-pic-placeholder.JPEG?alt=media&token=0f93dc94-dd77-4072-82bd-925a3b19acf3"
        const registeredUser= await db.register_site_user([user_name, hash, email, first_name, is_admin, is_sudo, photo_url])
