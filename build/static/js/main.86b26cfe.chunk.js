...
`,Ue=Object(v.c)(ge)`
    height:80px;
    width:100%;
`;var Fe=e=>{const{video_url:t,firebase_url:s,category:i,tag:n,photo_url:o,user_name:a,name:r,video_name:c,model_id:l}=e;return Object(C.jsxs)(Le,{children:[Object(C.jsxs)(Ne,{children:[Object(C.jsx)(W.c,{to:"/viewuser/12",children:Object(C.jsx)(Ie,{src:o})}),Object(C.jsxs)("h5",{children:["dummy project"===r?c:r,Object(C.jsx)("br",{}),Object(C.jsx)(Ce,{to:"/viewuser/12",children:Object(C.jsxs)("i",{children:["Video by ",a]})})]})]}),Object(C.jsx)(Me,{children:Object(C.jsx)(_e.a,{url:t,width:"298px",height:"191px",controls:!0})}),Object(C.jsx)(Se,{children:Object(C.jsx)(_e.a,{url:t,width:"100%",height:"150px",controls:!0})}),Object(C.jsxs)("div",{className:"video-info-container",children:[Object(C.jsx)("header",{className:"video-header",children:Object(C.jsxs)("p",{className:"video-header-text",children:[i,": ",n]})}),null===s?Object(C.jsx)("p",{className:"video-container-text",children:"There are no files associated with this video"}):Object(C.jsx)("p",{className:"video-container-text",children:Object(C.jsx)(W.c,{to:`/projectdetails/${l}`,children:"view details"})})]}),Object(C.jsx)(Ue,{})]})};const Pe=v.c.div`
    width: ${350}px;
    height: ${350}px;
    position: relative;    
    margin: auto;
...
`;var Re=e=>{let{state:t,mappedModels:s,mappedVideos:i,cubeRotations:n}=e;const{yRotation:o}=t,a=[...s,...i],r=300*a.length,c=a.map((e,t)=>{const s=t+1,i=s*n+o;return Object(C.jsx)(De,{cubeParams:300,i:t+1,cubeRotations:n,rotationIters:i,yRotation:o*s,children:Object(C.jsx)(Ee,{rotationIters:-i,children:e})},t)});return Object(C.jsx)(Pe,{circumference:r,children:Object(C.jsx)(Te,{rotation:o,cubeParams:300*a.length/2,children:c})})},Ae=s.p+"static/media/blender_background.a862b66c.png";const Be=v.c.section`
    position:relative;
    height: 90vh;
    width: 100vw;
    background-image: linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0)),url(${Ae});
...
`,Ge=v.c.button`
    ${ze}
    right:3px;
    `;class We extends i.Component{constructor(){super(),this.getFeaturedVideos=async()=>{this.setLoading();try{await this.props.getFeatured(),await c.a.get("/api/videos/featured").then(e=>{this.setState({videos:e.data,loading:!1})})}catch(e){alert("Content not available"),this.setLoading()}},this.state={projects:[],videos:[],user_name:"",password:"",userLikes:null,loading:!1,yRotation:0},this.stateHandler=this.stateHandler.bind(this),this.projectIsLiked=this.projectIsLiked.bind(this)}componentDidMount(){this.getFeaturedVideos()}setLoading(){this.setState({loading:!this.state.loading})}stateHandler(e,t){this.setState({[e]:t})}projectIsLiked(e,t){try{return t.filter(t=>t.model_id===e)[0].model_id===e}catch(s){console.log("user does not like this project",s)}}render(){const{loading:e,videos:t}=this.state,{isLoggedIn:s}=this.props.user,{user_likes:i,model_likes:n}=this.props.user.user,{featured:o}=this.props.models,a=360/[...t,...o].length,r=o.map(e=>Object(C.jsx)(ye,{data:e,projectIsLiked:this.projectIsLiked,isLoggedIn:s,model_likes:n,likes:e.likes,id:e.user_id,user_likes:i},e.model_id)),c=t.map(e=>Object(C.jsx)(Fe,{video_url:e.video_url,category:e.category,tag:e.tag,firebase_url:e.firebase_url,photo_url:e.photo_url,user_name:e.user_name,name:e.name,video_name:e.video_name,model_id:e.model_id},e.video_id));return Object(C.jsxs)(Be,{children:[!e||Object(C.jsx)(X,{}),Object(C.jsx)($e,{children:Object(C.jsx)(Re,{state:this.state,props:this.props,setState:this.setState,projectIsLiked:this.projectIsLiked,mappedModels:r,mappedVideos:c,cubeRotations:a})}),Object(C.jsx)(Ve,{onClick:()=>this.stateHandler("yRotation",this.state.yRotation+a),children:Object(C.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6",children:Object(C.jsx)("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M15.75 19.5L8.25 12l7.5-7.5"})})}),Object(C.jsx)(Ge,{onClick:()=>this.stateHandler("yRotation",this.state.yRotation-a),children:Object(C.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6",children:Object(C.jsx)("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M8.25 4.5l7.5 7.5-7.5 7.5"})})})]})}}var He=Object(O.b)(function(e){return e},{loginUser:b,updateUser:f,getModels:de,getFeatured:function(){return{type:le,payload:c.a.get("api/featured/join")}}})(We);s(117);var Je=e=>Object(C.jsxs)("div",{className:"group-page",children:[Object(C.jsx)("ul",{}),Object(C.jsx)("h3",{children:"group page"})]});s(30);const qe="GET_PROJECTS";function Ye(){return{type:qe,payload:c.a.get("/api/projects/all")}}var Xe=s(26),Ze=s.n(Xe);const Ke=s(63).a.initializeApp({apiKey:"AIzaSyB6ImzEUWfnyXD6bcpNEN8ktaMSfos8Js0",authDomain:"depot-7bb3e.firebaseapp.com",projectId:"depot-7bb3e",storageBucket:"depot-7bb3e.appspot.com",messagingSenderId:"38861699624",appId:"1:38861699624:web:b1d9abfce822f3a4d2531d",measurementId:"G-DSTFFPFHLD"}),Qe=(Ke.firestore(),{isLoading:!1,url:{},error:!1}),et="DELETE_FILE",tt="ADD_TO_FIREBASE",st="REF_FROM_URL",it=e=>{const t=Ke.storage().refFromURL(e);return{type:et,payload:t.delete().then(function(e){})}},nt=(e,t)=>{const s=Ke.storage().ref(t).child(e.name).put(e);return{type:tt,payload:s}};s(118),s(119);const ot=v.c.section`
    position: fixed;
    top: 100px;
    height: 350px;
    width: 400px;
...
`,bt=v.c.input`
    ...
    z-index: 10000;
    ${gt}
`;var wt=e=>{let{handleFile:t,getFileName:s}=e;return Object(C.jsx)(xt,{children:Object(C.jsxs)("div",{children:[Object(C.jsx)(jt,{children:s()}),Object(C.jsx)(bt,{style:{marginLeft:"40px"},type:"file",accept:".blend,.stl",onChange:e=>t(e)})]})})};const ft=v.c.div`
    position: relative;
    height: 90px;
    width: 100%;
    display: flex;
...
`;var bs=Object(O.b)(e=>e)(e=>{const{url:t,maker_id:s,id:n,model_id:o,getImages:a,main_image_url:r,stateHandler:l}=e,[d,h]=Object(i.useState)(!1);return Object(C.jsxs)(us,{children:[s===n&&null!=t&&Object(C.jsx)(ms,{openMenu:d,setOpenMenu:h}),!0===d&&s===n?Object(C.jsxs)(gs,{style:{top:"3  0px",left:"15px",height:"85px",width:"210px"},children:[Object(C.jsxs)(xs,{onClick:()=>(h(!d),void c.a.post("/api/projects/photos/change/main/",{model_id:o,url:t})),children:[Object(C.jsx)(P,{}),Object(C.jsx)("p",{children:"Display As Main Photo"})]}),Object(C.jsxs)(xs,{onClick:()=>(async e=>{try{await it(e)}catch(s){const e=null;c.a.post("/api/projects/photos/change/main/",{model_id:o,gone:e})}const t=await c.a.post("/api/projects/photos/delete/",{url:e,main_image_url:r,model_id:o}).then(e=>{l("selectedPhoto",null)});return await a(),h(!d),t})(t),children:[Object(C.jsx)(M,{}),Object(C.jsx)("p",{children:"Delete This Photo"})]})]}):null,Object(C.jsx)(js,{src:t})]})});s(57);const ws=v.c.div`
    position: relative;
    height: 120px;
    width: 90%;
    margin: 5px;
...
`;var ys=Object(O.b)(function(e){return e},{updateUser:f})(e=>{const{content:t,photo_url:s,user_id:n,comment_id:o}=e,{id:a}=e.user.user,[r,l]=Object(i.useState)(!1);return Object(C.jsxs)(ws,{children:[Object(C.jsx)(fs,{src:s}),Object(C.jsxs)(Os,{children:[Object(C.jsx)(vs,{children:Object(C.jsx)("p",{children:t})}),void 0!=a&&a===n&&Object(C.jsx)(S,{onClick:()=>l(!r)}),r&&Object(C.jsx)("ul",{className:"friend-options",style:{width:"130px",height:"40px"},children:Object(C.jsxs)("li",{className:"friend-menu-row",onClick:()=>(async()=>{n===a&&await c.a.delete(`/api/comments/user/delete/${o}`).then(()=>{e.getComments()})})(),children:[Object(C.jsx)(M,{}),Object(C.jsx)("p",{className:"friend-menu-text",children:"Delete post"})]})})]})]})});class ks extends i.Component{constructor(){super(),this.state={text:""},this.handleText=this.handleText.bind(this),this.sendPost=this.sendPost.bind(this)}sendPost(e){const{text:t}=this.state,{id:s,model_id:i,user:n}=this.props;!0===e?c.a.post("/api/comments/create",{id:s,model_id:i,user:n,text:t}).then(this.props.getComments):this.props.plsSignIn()}handleText(e,t){this.setState({[e]:t})}render(){const{isLoggedIn:e}=this.props;return Object(C.jsxs)("div",{className:"create-post",style:{minHeight:"100px"},children:[Object(C.jsx)("textarea",{className:"comment-text-input post-input",value:this.state.text,name:"text",rows:"5",cols:"50",wrap:"soft",onChange:e=>this.handleText("text",e.target.value),children:" "}),Object(C.jsx)("a",{className:"add-button",onClick:()=>this.sendPost(e),style:{marginLeft:"200px"},children:"send"})]})}}var _s=e=>{const{url:t,isLoggedIn:s}=e;return Object(C.jsx)("div",{children:s?Object(C.jsx)("a",{className:"dark-text",href:t,target:"_blank",rel:"noopener noreferrer",children:"Download"}):Object(C.jsx)("a",{className:"dark-text",onClick:e.plsSignIn,children:"Download"})})};const Ls=v.c.div`
    position:relative;
    height: 70px;
    width:100%;
    background-color: #fff;
...
`;var Ns=e=>{const{info:t,userInfo:s}=e,{user_name:i,photo_url:n}=s;return Object(C.jsxs)(Ls,{children:[Object(C.jsx)("img",{src:n}),Object(C.jsxs)("h4",{children:[t.name,Object(C.jsx)("br",{style:{paddingBottom:"10px"}}),Object(C.jsxs)(W.c,{to:`/viewuser/${s.user_id}`,children:["by ",i]})]})]})};const Cs=v.c.section`
    width: 220px;
...
`,Ms={backgroundColor:"#3c598e"};var Us=e=>{const{state:t,isLoggedIn:s,authorized:i,clickLike:n,changeView:o}=e,{viewFiles:a,myLike:r,viewComments:c,viewEditProject:l,addedToFavorites:d,viewInfo:h}=t;return Object(C.jsxs)(Cs,{children:[Object(C.jsx)("li",{style:a?Ms:null,onClick:()=>o("viewFiles"),children:Object(C.jsx)(Is,{viewFiles:a,children:"Download Files"})}),Object(C.jsxs)("li",{onClick:n,children:[!0===s&&!0===r?Object(C.jsx)(U,{}):Object(C.jsx)(F,{}),Object(C.jsx)(Ss,{children:"Like"})]}),Object(C.jsxs)("li",{style:c?Ms:null,onClick:()=>o("viewComments"),children:[Object(C.jsx)(he,{params:"comments"}),Object(C.jsx)(Ss,{condition:c,children:"Comments"})]}),Object(C.jsxs)("li",{style:l||d?Ms:null,onClick:()=>o(!0===i()?"viewEditProject":"viewInfo"),children:[!0===i()?Object(C.jsx)(he,{params:"edit_project",fill:"none",stroke:"currentColor"}):Object(C.jsx)(he,{params:"folder",fill:"none",stroke:"currentColor"}),Object(C.jsx)(Ss,{condition:l||d,children:i()?"Edit Project":"Add to Favorites"})]}),Object(C.jsxs)("li",{style:h?Ms:null,onClick:()=>o("viewInfo"),children:[Object(C.jsx)(he,{params:"info",fill:"none",stroke:"currentColor"}),Object(C.jsx)(Ss,{condition:h,children:"Info"})]})]})};const Fs=v.c.section`
    margin: none;
    min-height: 90vh;
    min-width: 100vw;
    background-size: cover; 
