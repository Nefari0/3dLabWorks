...
`;var Oe=e=>{let{state:t,mappedModels:s,mappedVideos:i,cubeRotations:n}=e;const{yRotation:o}=t,a=[...s,...i],r=300*a.length,l=a.map((e,t)=>{const s=t+1,i=s*n+o;return Object(y.jsx)(we,{cubeParams:300,i:t+1,cubeRotations:n,rotationIters:i,yRotation:o*s,children:Object(y.jsx)(fe,{rotationIters:-i,children:e})},t)});return Object(y.jsx)(xe,{circumference:r,children:Object(y.jsx)(be,{rotation:o,cubeParams:300*a.length/2,children:l})})},ve=s.p+"static/media/blender_background.a862b66c.png";const ke=v.b.section`
    position:relative;
    height: 90vh;
    width: 100vw;
...
`,Ne=v.b.button`
    ${_e}
    right:3px;
    `;class Ce extends i.Component{constructor(){super(),this.getFeaturedVideos=async()=>{this.setLoading();try{await this.props.getFeatured(),await l.a.get("/api/videos/featured").then(e=>{this.setState({videos:e.data,loading:!1})})}catch(e){alert("Content not available"),this.setLoading()}},this.state={projects:[],videos:[],user_name:"",password:"",userLikes:null,loading:!1,yRotation:0},this.stateHandler=this.stateHandler.bind(this),this.projectIsLiked=this.projectIsLiked.bind(this)}componentDidMount(){this.getFeaturedVideos()}setLoading(){this.setState({loading:!this.state.loading})}stateHandler(e,t){this.setState({[e]:t})}projectIsLiked(e,t){try{return t.filter(t=>t.model_id===e)[0].model_id===e}catch(s){console.log("user does not like this project",s)}}render(){const{loading:e,videos:t}=this.state,{isLoggedIn:s}=this.props.user,{user_likes:i,model_likes:n}=this.props.user.user,{featured:o}=this.props.models,a=360/[...t,...o].length,r=o.map(e=>Object(y.jsx)(me,{data:e,projectIsLiked:this.projectIsLiked,isLoggedIn:s,model_likes:n,likes:e.likes,id:e.user_id,user_likes:i},e.model_id)),l=t.map(e=>Object(y.jsx)(je,{video_url:e.video_url,category:e.category,tag:e.tag,firebase_url:e.firebase_url,photo_url:e.photo_url,user_name:e.user_name,name:e.name,video_name:e.video_name},e.video_id));return Object(y.jsxs)(ke,{children:[!e||Object(y.jsx)(H,{}),Object(y.jsx)(ye,{children:Object(y.jsx)(Oe,{state:this.state,props:this.props,setState:this.setState,projectIsLiked:this.projectIsLiked,mappedModels:r,mappedVideos:l,cubeRotations:a})}),Object(y.jsx)(Le,{onClick:()=>this.stateHandler("yRotation",this.state.yRotation+a),children:Object(y.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6",children:Object(y.jsx)("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M15.75 19.5L8.25 12l7.5-7.5"})})}),Object(y.jsx)(Ne,{onClick:()=>this.stateHandler("yRotation",this.state.yRotation-a),children:Object(y.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6",children:Object(y.jsx)("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M8.25 4.5l7.5 7.5-7.5 7.5"})})})]})}}var Ie=Object(O.b)(function(e){return e},{loginUser:b,updateUser:f,getModels:ae,getFeatured:function(){return{type:oe,payload:l.a.get("api/featured/join")}}})(Ce);s(116);var Se=e=>Object(y.jsxs)("div",{className:"group-page",children:[Object(y.jsx)("ul",{}),Object(y.jsx)("h3",{children:"group page"})]});s(30);const Me="GET_PROJECTS";function Ue(){return{type:Me,payload:l.a.get("/api/projects/all")}}var Fe=s(24),Pe=s.n(Fe);const Te=s(64).a.initializeApp({apiKey:"AIzaSyB6ImzEUWfnyXD6bcpNEN8ktaMSfos8Js0",authDomain:"depot-7bb3e.firebaseapp.com",projectId:"depot-7bb3e",storageBucket:"depot-7bb3e.appspot.com",messagingSenderId:"38861699624",appId:"1:38861699624:web:b1d9abfce822f3a4d2531d",measurementId:"G-DSTFFPFHLD"}),De=(Te.firestore(),{isLoading:!1,url:{},error:!1}),Ee="DELETE_FILE",Re="ADD_TO_FIREBASE",Ae="REF_FROM_URL",Be=e=>{const t=Te.storage().refFromURL(e);return{type:Ee,payload:t.delete().then(function(e){})}},ze=(e,t)=>{const s=Te.storage().ref(t).child(e.name).put(e);return{type:Re,payload:s}};s(117),s(118);const Ve=v.b.section`
    position: fixed;
    top: 100px;
    height: 350px;
    width: 400px;
...
`,tt=v.b.input`
    ...
    z-index: 10000;
    ${Ke}
`;var st=e=>{let{handleFile:t,getFileName:s}=e;return Object(y.jsx)(Qe,{children:Object(y.jsxs)("div",{children:[Object(y.jsx)(et,{children:s()}),Object(y.jsx)(tt,{style:{marginLeft:"40px"},type:"file",accept:".blend,.stl",onChange:e=>t(e)})]})})};const it=v.b.div`
    position: relative;
    height: 90px;
    width: 100%;
    display: flex;
...
`;var Yt=Object(O.b)(e=>e)(e=>{const{url:t,maker_id:s,id:n,model_id:o,getImages:a,main_image_url:r,stateHandler:c}=e,[d,h]=Object(i.useState)(!1);return Object(y.jsxs)(Wt,{children:[s===n&&null!=t&&Object(y.jsx)(Gt,{openMenu:d,setOpenMenu:h}),!0===d&&s===n?Object(y.jsxs)(Ht,{style:{top:"3  0px",left:"15px",height:"85px",width:"210px"},children:[Object(y.jsxs)(Jt,{onClick:()=>(h(!d),void l.a.post("/api/projects/photos/change/main/",{model_id:o,url:t})),children:[Object(y.jsx)(S,{}),Object(y.jsx)("p",{children:"Display As Main Photo"})]}),Object(y.jsxs)(Jt,{onClick:()=>(async e=>{try{await Be(e)}catch(s){const e=null;l.a.post("/api/projects/photos/change/main/",{model_id:o,gone:e})}const t=await l.a.post("/api/projects/photos/delete/",{url:e,main_image_url:r,model_id:o}).then(e=>{c("selectedPhoto",null)});return await a(),h(!d),t})(t),children:[Object(y.jsx)(N,{}),Object(y.jsx)("p",{children:"Delete This Photo"})]})]}):null,Object(y.jsx)(qt,{src:t})]})});s(58);const Xt=v.b.div`
    position: relative;
    height: 120px;
    width: 90%;
    margin: 5px;
...
`;var es=Object(O.b)(function(e){return e},{updateUser:f})(e=>{const{content:t,photo_url:s,user_id:n,comment_id:o}=e,{id:a}=e.user.user,[r,c]=Object(i.useState)(!1);return Object(y.jsxs)(Xt,{children:[Object(y.jsx)(Zt,{src:s}),Object(y.jsxs)(Kt,{children:[Object(y.jsx)(Qt,{children:Object(y.jsx)("p",{children:t})}),void 0!=a&&a===n&&Object(y.jsx)(L,{onClick:()=>c(!r)}),r&&Object(y.jsx)("ul",{className:"friend-options",style:{width:"130px",height:"40px"},children:Object(y.jsxs)("li",{className:"friend-menu-row",onClick:()=>(async()=>{n===a&&await l.a.delete(`/api/comments/user/delete/${o}`).then(()=>{e.getComments()})})(),children:[Object(y.jsx)(N,{}),Object(y.jsx)("p",{className:"friend-menu-text",children:"Delete post"})]})})]})]})});class ts extends i.Component{constructor(){super(),this.state={text:""},this.handleText=this.handleText.bind(this),this.sendPost=this.sendPost.bind(this)}sendPost(e){const{text:t}=this.state,{id:s,model_id:i,user:n}=this.props;!0===e?l.a.post("/api/comments/create",{id:s,model_id:i,user:n,text:t}).then(this.props.getComments):this.props.plsSignIn()}handleText(e,t){this.setState({[e]:t})}render(){const{isLoggedIn:e}=this.props;return Object(y.jsxs)("div",{className:"create-post",style:{minHeight:"100px"},children:[Object(y.jsx)("textarea",{className:"comment-text-input post-input",value:this.state.text,name:"text",rows:"5",cols:"50",wrap:"soft",onChange:e=>this.handleText("text",e.target.value),children:" "}),Object(y.jsx)("a",{className:"add-button",onClick:()=>this.sendPost(e),style:{marginLeft:"200px"},children:"send"})]})}}var ss=e=>{const{url:t,isLoggedIn:s}=e;return Object(y.jsx)("div",{children:s?Object(y.jsx)("a",{className:"dark-text",href:t,target:"_blank",rel:"noopener noreferrer",children:"Download"}):Object(y.jsx)("a",{className:"dark-text",onClick:e.plsSignIn,children:"Download"})})};const is=v.b.div`
    height: 70px;
    width: 680px;
    background-color: #fff;
    display: flex;
    ...
    @media (max-width:680px) {
        width: 100%;
`;var ns=e=>{const{info:t,userInfo:s}=e,{user_name:i,photo_url:n}=s;return Object(y.jsxs)(is,{children:[Object(y.jsx)("img",{src:n}),Object(y.jsxs)("h4",{children:[t.name,Object(y.jsx)("br",{style:{paddingBottom:"10px"}}),Object(y.jsxs)(z.c,{to:`/viewuser/${s.user_id}`,children:["by ",i]})]})]})};const os=v.b.h4`
    padding-top: 15px;
    padding-bottom: 5px;
...
`,rs={backgroundColor:"#3c598e"};var ls=e=>{const{state:t,isLoggedIn:s,authorized:i,clickLike:n,changeView:o}=e,{viewFiles:a,myLike:r,viewComments:l,viewEditProject:c,addedToFavorites:d,viewInfo:h}=t;return Object(y.jsxs)("ul",{children:[Object(y.jsx)("li",{style:a?rs:null,onClick:()=>o("viewFiles"),children:Object(y.jsx)(os,{viewFiles:a,children:"Download Files"})}),Object(y.jsxs)("li",{onClick:n,children:[!0===s&&!0===r?Object(y.jsx)(C,{}):Object(y.jsx)(I,{}),Object(y.jsx)(as,{children:"Like"})]}),Object(y.jsxs)("li",{style:l?rs:null,onClick:()=>o("viewComments"),children:[Object(y.jsx)(re,{params:"comments"}),Object(y.jsx)(as,{condition:l,children:"Comments"})]}),Object(y.jsxs)("li",{style:c||d?rs:null,onClick:()=>o(!0===i()?"viewEditProject":"viewInfo"),children:[!0===i()?Object(y.jsx)(re,{params:"edit_project",fill:"none",stroke:"currentColor"}):Object(y.jsx)(re,{params:"folder",fill:"none",stroke:"currentColor"}),Object(y.jsx)(as,{condition:c||d,children:i()?"Edit Project":"Add to Favorites"})]}),Object(y.jsxs)("li",{style:h?rs:null,onClick:()=>o("viewInfo"),children:[Object(y.jsx)(re,{params:"info",fill:"none",stroke:"currentColor"}),Object(y.jsx)(as,{condition:h,children:"Info"})]})]})};const cs=v.b.section`
    margin: none;
    min-height: 90vh;
    min-width: 100vw;
    // min-width:100px;
