(this.webpackJsonp3depot=this.webpackJsonp3depot||[]).push([[0],Array(30).concat([function(e,t,s){},function(e,t,s){},function(e,t,s){},,,,,function(e,t,s){},,,,,function(e,t,s){},,,,,,,,,function(e,t,s){},,,,function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},,,,,,function(e,t){},,,,,,,,,,function(e,t,s){},,,,,,,,,,,,,,,,,,,,,,,,,,,function(e,t,s){},,,function(e,t,s){},function(e,t,s){},,,,,,function(e,t,s){},,,,,,function(e,t,s){},function(e,t){},function(e,t,s){},function(e,t,s){},function(e,t,s){},,,,function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){},function(e,t,s){"use strict";s.r(t);var i=s(3),n=s.n(i),o=s(33),a=s.n(o),r=(s(74),s(42),s(138),s(4)),l=s.n(r);s(97);const c={user:{},isLoggedIn:!1,isLoading:!1,loginError:!1,loginOpen:!1},d="LOGIN_USER",h="LOGOUT_USER",p="REGISTER_USER",m="UPDATE_USER",u="SHOW_DATA",g="AUTO_LOGIN",x="OPEN_LOGIN";function j(e){return{type:x,payload:e}}function b(e,t,s,i){return{type:d,payload:l.a.post("/auth/login",{user_name:e,password:t,last_visit:s,visited:i})}}function w(e,t,s,i,n,o){return{type:p,payload:l.a.post("/auth/register",{user_name:e,password:t,email:s,first_name:i,is_admin:n,is_sudo:o})}}function f(e){return{type:m,payload:e}}var O=s(7),v=(s(101),s(5));const y=v.b.header`
    position: relative;
    margin: none;
    height: 60px;
    min-width: 300px;
...
`;var ye=e=>{const{video_url:t,firebase_url:s,category:i,tag:n,photo_url:o,user_name:a,name:r,video_name:l,model_id:c}=e;return Object(C.jsxs)(fe,{className:"player-container",children:[Object(C.jsxs)(Oe,{className:"video-title",children:[Object(C.jsx)(W.c,{to:"/viewuser/12",children:Object(C.jsx)("img",{className:"video-user-photo",src:o})}),Object(C.jsxs)("div",{children:[Object(C.jsx)("h4",{className:"dark-text video-nm-txt",children:"dummy project"===r?l:r}),Object(C.jsx)(ve,{to:"/viewuser/12",children:Object(C.jsxs)("i",{children:["Video by ",a]})})]})]}),Object(C.jsxs)("div",{className:"",style:{marginTop:"50px"},children:[Object(C.jsx)("div",{className:"reg-size",children:Object(C.jsx)(we.a,{className:"react-player",url:t,width:"298px",height:"191px",controls:!0})}),Object(C.jsx)("div",{className:"small-size",children:Object(C.jsx)(we.a,{className:"react-player",url:t,width:"240px",height:"150px",controls:!0})}),Object(C.jsxs)("div",{className:"video-info-container",children:[Object(C.jsx)("header",{className:"video-header",children:Object(C.jsxs)("p",{className:"video-header-text",children:[i,": ",n]})}),null===s?Object(C.jsx)("p",{className:"video-container-text",children:"There are no files associated with this video"}):Object(C.jsx)("p",{className:"video-container-text",children:Object(C.jsx)(W.c,{to:`/projectdetails/${c}`,children:"view details"})})]})]})]})};const ke=v.b.div`
    width: ${350}px;
    height: ${350}px;
    position: relative;    
    margin: auto;
...
`;var Ce=e=>{let{state:t,mappedModels:s,mappedVideos:i,cubeRotations:n}=e;const{yRotation:o}=t,a=[...s,...i],r=300*a.length,l=a.map((e,t)=>{const s=t+1,i=s*n+o;return Object(C.jsx)(Le,{cubeParams:300,i:t+1,cubeRotations:n,rotationIters:i,yRotation:o*s,children:Object(C.jsx)(Ne,{rotationIters:-i,children:e})},t)});return Object(C.jsx)(ke,{circumference:r,children:Object(C.jsx)(_e,{rotation:o,cubeParams:300*a.length/2,children:l})})},Ie=s.p+"static/media/blender_background.a862b66c.png";const Se=v.b.section`
    position:relative;
    height: 90vh;
    width: 100vw;
    background-image: linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0)),url(${Ie});
...
`,Pe=v.b.button`
    ${Ue}
    right:3px;
    `;class Te extends i.Component{constructor(){super(),this.getFeaturedVideos=async()=>{this.setLoading();try{await this.props.getFeatured(),await l.a.get("/api/videos/featured").then(e=>{this.setState({videos:e.data,loading:!1})})}catch(e){alert("Content not available"),this.setLoading()}},this.state={projects:[],videos:[],user_name:"",password:"",userLikes:null,loading:!1,yRotation:0},this.stateHandler=this.stateHandler.bind(this),this.projectIsLiked=this.projectIsLiked.bind(this)}componentDidMount(){this.getFeaturedVideos()}setLoading(){this.setState({loading:!this.state.loading})}stateHandler(e,t){this.setState({[e]:t})}projectIsLiked(e,t){try{return t.filter(t=>t.model_id===e)[0].model_id===e}catch(s){console.log("user does not like this project",s)}}render(){const{loading:e,videos:t}=this.state,{isLoggedIn:s}=this.props.user,{user_likes:i,model_likes:n}=this.props.user.user,{featured:o}=this.props.models,a=360/[...t,...o].length,r=o.map(e=>Object(C.jsx)(je,{data:e,projectIsLiked:this.projectIsLiked,isLoggedIn:s,model_likes:n,likes:e.likes,id:e.user_id,user_likes:i},e.model_id)),l=t.map(e=>Object(C.jsx)(ye,{video_url:e.video_url,category:e.category,tag:e.tag,firebase_url:e.firebase_url,photo_url:e.photo_url,user_name:e.user_name,name:e.name,video_name:e.video_name,model_id:e.model_id},e.video_id));return Object(C.jsxs)(Se,{children:[!e||Object(C.jsx)(X,{}),Object(C.jsx)(Me,{children:Object(C.jsx)(Ce,{state:this.state,props:this.props,setState:this.setState,projectIsLiked:this.projectIsLiked,mappedModels:r,mappedVideos:l,cubeRotations:a})}),Object(C.jsx)(Fe,{onClick:()=>this.stateHandler("yRotation",this.state.yRotation+a),children:Object(C.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6",children:Object(C.jsx)("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M15.75 19.5L8.25 12l7.5-7.5"})})}),Object(C.jsx)(Pe,{onClick:()=>this.stateHandler("yRotation",this.state.yRotation-a),children:Object(C.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6",children:Object(C.jsx)("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M8.25 4.5l7.5 7.5-7.5 7.5"})})})]})}}var De=Object(O.b)(function(e){return e},{loginUser:b,updateUser:f,getModels:de,getFeatured:function(){return{type:ce,payload:l.a.get("api/featured/join")}}})(Te);s(117);var Ee=e=>Object(C.jsxs)("div",{className:"group-page",children:[Object(C.jsx)("ul",{}),Object(C.jsx)("h3",{children:"group page"})]});s(30);const Re="GET_PROJECTS";function Ae(){return{type:Re,payload:l.a.get("/api/projects/all")}}var $e=s(26),Be=s.n($e);const ze=s(63).a.initializeApp({apiKey:"AIzaSyB6ImzEUWfnyXD6bcpNEN8ktaMSfos8Js0",authDomain:"depot-7bb3e.firebaseapp.com",projectId:"depot-7bb3e",storageBucket:"depot-7bb3e.appspot.com",messagingSenderId:"38861699624",appId:"1:38861699624:web:b1d9abfce822f3a4d2531d",measurementId:"G-DSTFFPFHLD"}),Ve=(ze.firestore(),{isLoading:!1,url:{},error:!1}),Ge="DELETE_FILE",We="ADD_TO_FIREBASE",He="REF_FROM_URL",Je=e=>{const t=ze.storage().refFromURL(e);return{type:Ge,payload:t.delete().then(function(e){})}},qe=(e,t)=>{const s=ze.storage().ref(t).child(e.name).put(e);return{type:We,payload:s}};s(118),s(119);const Ye=v.b.section`
    position: fixed;
    top: 100px;
    height: 350px;
    width: 400px;
...
`,lt=v.b.input`
    ...
    z-index: 10000;
    ${ot}
`;var ct=e=>{let{handleFile:t,getFileName:s}=e;return Object(C.jsx)(at,{children:Object(C.jsxs)("div",{children:[Object(C.jsx)(rt,{children:s()}),Object(C.jsx)(lt,{style:{marginLeft:"40px"},type:"file",accept:".blend,.stl",onChange:e=>t(e)})]})})};const dt=v.b.div`
    position: relative;
    height: 90px;
    width: 100%;
    display: flex;
...
`,jt={largeWidth:1e3,medWidth:600,smallWidth:300},{largeWidth:bt,medWidth:wt,smallWidth:ft}=jt,Ot=v.a`
    @media(max-width:1100px) {
        width:${wt}px;
    }
`,vt=v.a`
...
`;var ps=Object(O.b)(e=>e)(e=>{const{url:t,maker_id:s,id:n,model_id:o,getImages:a,main_image_url:r,stateHandler:c}=e,[d,h]=Object(i.useState)(!1);return Object(C.jsxs)(ls,{children:[s===n&&null!=t&&Object(C.jsx)(rs,{openMenu:d,setOpenMenu:h}),!0===d&&s===n?Object(C.jsxs)(cs,{style:{top:"3  0px",left:"15px",height:"85px",width:"210px"},children:[Object(C.jsxs)(ds,{onClick:()=>(h(!d),void l.a.post("/api/projects/photos/change/main/",{model_id:o,url:t})),children:[Object(C.jsx)(P,{}),Object(C.jsx)("p",{children:"Display As Main Photo"})]}),Object(C.jsxs)(ds,{onClick:()=>(async e=>{try{await Je(e)}catch(s){const e=null;l.a.post("/api/projects/photos/change/main/",{model_id:o,gone:e})}const t=await l.a.post("/api/projects/photos/delete/",{url:e,main_image_url:r,model_id:o}).then(e=>{c("selectedPhoto",null)});return await a(),h(!d),t})(t),children:[Object(C.jsx)(M,{}),Object(C.jsx)("p",{children:"Delete This Photo"})]})]}):null,Object(C.jsx)(hs,{src:t})]})});s(57);const ms=v.b.div`
    position: relative;
    height: 120px;
    width: 90%;
    margin: 5px;
...
`;var js=Object(O.b)(function(e){return e},{updateUser:f})(e=>{const{content:t,photo_url:s,user_id:n,comment_id:o}=e,{id:a}=e.user.user,[r,c]=Object(i.useState)(!1);return Object(C.jsxs)(ms,{children:[Object(C.jsx)(us,{src:s}),Object(C.jsxs)(gs,{children:[Object(C.jsx)(xs,{children:Object(C.jsx)("p",{children:t})}),void 0!=a&&a===n&&Object(C.jsx)(S,{onClick:()=>c(!r)}),r&&Object(C.jsx)("ul",{className:"friend-options",style:{width:"130px",height:"40px"},children:Object(C.jsxs)("li",{className:"friend-menu-row",onClick:()=>(async()=>{n===a&&await l.a.delete(`/api/comments/user/delete/${o}`).then(()=>{e.getComments()})})(),children:[Object(C.jsx)(M,{}),Object(C.jsx)("p",{className:"friend-menu-text",children:"Delete post"})]})})]})]})});class bs extends i.Component{constructor(){super(),this.state={text:""},this.handleText=this.handleText.bind(this),this.sendPost=this.sendPost.bind(this)}sendPost(e){const{text:t}=this.state,{id:s,model_id:i,user:n}=this.props;!0===e?l.a.post("/api/comments/create",{id:s,model_id:i,user:n,text:t}).then(this.props.getComments):this.props.plsSignIn()}handleText(e,t){this.setState({[e]:t})}render(){const{isLoggedIn:e}=this.props;return Object(C.jsxs)("div",{className:"create-post",style:{minHeight:"100px"},children:[Object(C.jsx)("textarea",{className:"comment-text-input post-input",value:this.state.text,name:"text",rows:"5",cols:"50",wrap:"soft",onChange:e=>this.handleText("text",e.target.value),children:" "}),Object(C.jsx)("a",{className:"add-button",onClick:()=>this.sendPost(e),style:{marginLeft:"200px"},children:"send"})]})}}var ws=e=>{const{url:t,isLoggedIn:s}=e;return Object(C.jsx)("div",{children:s?Object(C.jsx)("a",{className:"dark-text",href:t,target:"_blank",rel:"noopener noreferrer",children:"Download"}):Object(C.jsx)("a",{className:"dark-text",onClick:e.plsSignIn,children:"Download"})})};const fs=v.b.div`
    height: 70px;
    width: 680px;
    background-color: #fff;
    display: flex;
    ...
    @media (max-width:680px) {
        width: 100%;
`;var Os=e=>{const{info:t,userInfo:s}=e,{user_name:i,photo_url:n}=s;return Object(C.jsxs)(fs,{children:[Object(C.jsx)("img",{src:n}),Object(C.jsxs)("h4",{children:[t.name,Object(C.jsx)("br",{style:{paddingBottom:"10px"}}),Object(C.jsxs)(W.c,{to:`/viewuser/${s.user_id}`,children:["by ",i]})]})]})};const vs=v.b.h4`
    padding-top: 15px;
    padding-bottom: 5px;
...
`,ks={backgroundColor:"#3c598e"};var _s=e=>{const{state:t,isLoggedIn:s,authorized:i,clickLike:n,changeView:o}=e,{viewFiles:a,myLike:r,viewComments:l,viewEditProject:c,addedToFavorites:d,viewInfo:h}=t;return Object(C.jsxs)("ul",{children:[Object(C.jsx)("li",{style:a?ks:null,onClick:()=>o("viewFiles"),children:Object(C.jsx)(vs,{viewFiles:a,children:"Download Files"})}),Object(C.jsxs)("li",{onClick:n,children:[!0===s&&!0===r?Object(C.jsx)(U,{}):Object(C.jsx)(F,{}),Object(C.jsx)(ys,{children:"Like"})]}),Object(C.jsxs)("li",{style:l?ks:null,onClick:()=>o("viewComments"),children:[Object(C.jsx)(he,{params:"comments"}),Object(C.jsx)(ys,{condition:l,children:"Comments"})]}),Object(C.jsxs)("li",{style:c||d?ks:null,onClick:()=>o(!0===i()?"viewEditProject":"viewInfo"),children:[!0===i()?Object(C.jsx)(he,{params:"edit_project",fill:"none",stroke:"currentColor"}):Object(C.jsx)(he,{params:"folder",fill:"none",stroke:"currentColor"}),Object(C.jsx)(ys,{condition:c||d,children:i()?"Edit Project":"Add to Favorites"})]}),Object(C.jsxs)("li",{style:h?ks:null,onClick:()=>o("viewInfo"),children:[Object(C.jsx)(he,{params:"info",fill:"none",stroke:"currentColor"}),Object(C.jsx)(ys,{condition:h,children:"Info"})]})]})};const Ls=v.b.section`
    margin: none;
    min-height: 90vh;
    min-width: 100vw;
    // min-width:100px;
